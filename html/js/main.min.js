...
"use strict";function beerSwiper(){$(window).width()<1024&&new Swiper(".beer__slider-container",{slidesPerView:"auto",spaceBetween:0,initialSlide:8})}function scooterTabs(){$(".scooter__btn").click(function(e){e.preventDefault();e=$(this).attr("data-img"),e=$('.scooter__img[data-img="'+e+'"]');$(".scooter__btn.scooter__btn--active").removeClass("scooter__btn--active"),$(this).addClass("scooter__btn--active"),$(".scooter__img.scooter__img--active").removeClass("scooter__img--active"),e.addClass("scooter__img--active")})}function galleryTabs(){$(".gallery__tabs-btn").click(function(e){e.preventDefault(),$(".gallery__tabs-bg").toggleClass("gallery__tabs-bg--active");e=$(this).attr("data-tab"),e=$('.gallery__list-sec[data-tab="'+e+'"]');$(".gallery__tabs-btn.gallery__tabs-btn--active").removeClass("gallery__tabs-btn--active"),$(this).addClass("gallery__tabs-btn--active"),$(".gallery__list-sec.gallery__list-sec--active").removeClass("gallery__list-sec--active"),e.addClass("gallery__list-sec--active")})}$(document).ready(function(){scooterTabs(),galleryTabs(),beerSwiper()});